...
execute if entity @s[predicate=!minecraft:sneaking,predicate=mystanic:mystanic_item_offhand] run say "click offhand, no sneak"
...
execute if entity @s[predicate=!minecraft:sneaking,predicate=mystanic:mystanic_item_mainhand,predicate=!mystanic:mystanic_item_offhand] run say "click mainhand, no sneak"
