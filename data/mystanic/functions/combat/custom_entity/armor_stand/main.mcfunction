...
execute if entity @s[tag=chromwand_shadow_marker] at @s run function mystanic:combat/custom_entity/armor_stand/shadow
execute if entity @s[tag=blind_eye] at @s run function mystanic:combat/custom_entity/armor_stand/blind_eye