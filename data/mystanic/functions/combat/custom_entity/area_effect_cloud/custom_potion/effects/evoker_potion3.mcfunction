...
execute as @s at @s unless entity @s[y_rotation=-59.99..0] run function mystanic:combat/custom_entity/area_effect_cloud/custom_potion/effects/evoker_potion3