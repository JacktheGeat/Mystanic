...
setblock ~ -64 ~ oak_sign{Text1:'[{"score":{"name":"@p[nbt={SelectedItem:{tag:{Mystanic:{id:\\"sword_of_avarice\\"}}}}]","objective":"avarice_kills"},"color":"dark_red","italic":false},{"text":"\\uE000","color":"red"}]'} replace
