...
execute if entity @n[type=area_effect_cloud,nbt={potion_contents:{custom_effects:[{id:"minecraft:unluck",amplifier:127b}]}}] as @e[type=area_effect_cloud,nbt={potion_contents:{custom_effects:[{id:"minecraft:unluck",amplifier:127b}]}}] at @s run function bee_keeper:bee_keeper/honey_spill/aoe_cloud